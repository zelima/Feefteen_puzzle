...
TILE = pygame.image.load("../img/buttontemplete.png")
PUSHED_BUTTON = pygame.image.load("../img/Pushed_button.png")
RELISED_BUTTON = pygame.image.load("../img/Relised_button.png")
ICON = pygame.image.load("../img/icon.png")
# Sound for sliding tiles
SOUND = pygame.mixer.Sound("../voice/slide.wav")
